(function($) {
  ...
  $(function() {
    if ($("#total-sales-chart").length) {
      let totalsales77 = new XMLHttpRequest()
      totalsales77.onload = function(){
  ...
  totalsales77.open("GET" , "https://inlupp-fa.azurewebsites.net/api/total-sales-chart ", true);
  totalsales77.send();
}
    ...
    if ($("#projects-chart").length) {
      let projectscharts2 = new XMLHttpRequest()
      projectscharts2.onload = function(){
      if(this.readyState == 4 && this.status == 200){
  ...
  projectscharts2.open("GET" , "https://inlupp-fa.azurewebsites.net/api/total-projects ", true);
  projectscharts2.send();
    }
    ...
    if ($("#distribution-chart-dark").length) {
      ...
      console.log(object6.procentage);
      var areaOptions = {
        responsive: true,
        maintainAspectRatio: true,
        segmentShowStroke: false,
  ...
  distribution.open("GET" , "https://inlupp-fa.azurewebsites.net/api/distribution" , true);
   distribution.send();
    ...
    if ($("#sale-report-chart").length) {
      ...
      salereport.onload = function () {
          if(this.readyState == 4 && this.status == 200) {
                 ...
                 console.log(object7.datasets[0].backgroundColor);
      ...
      var CurrentChart = new Chart(CurrentChartCanvas, {
        ...
        data: {
          ...
          datasets: [{
              ...
              backgroundColor: object7.datasets[0].backgroundColor
            }
          ]
        },
        options: {
  ...
  salereport.open("GET" , "https://inlupp-fa.azurewebsites.net/api/sales-report", true);
   salereport.send();
 }
  });
})(jQuery);